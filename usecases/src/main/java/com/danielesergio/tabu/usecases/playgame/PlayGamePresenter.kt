...
interface  PlayGamePresenter{
    fun showCard(cardOutput: CardOutput)
    fun roundEnd(currentTeam: TeamStatus, vararg othersTeam: TeamStatus)
    fun updateScore(teamStatus: TeamStatus)
    fun gameEnd(ranking:Array<TeamStatus>)
}